...
public class MensajeDAO {
	...
	public static Mensaje loadMensajeByORMID(PersistentSession session, int idMensaje) throws PersistentException {
		try {
			return (Mensaje) session.load(db_dcl.Mensaje.class, new Integer(idMensaje));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Mensaje getMensajeByORMID(PersistentSession session, int idMensaje) throws PersistentException {
		try {
			return (Mensaje) session.get(db_dcl.Mensaje.class, new Integer(idMensaje));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Mensaje loadMensajeByORMID(PersistentSession session, int idMensaje, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Mensaje) session.load(db_dcl.Mensaje.class, new Integer(idMensaje), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Mensaje getMensajeByORMID(PersistentSession session, int idMensaje, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Mensaje) session.get(db_dcl.Mensaje.class, new Integer(idMensaje), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Mensaje createMensaje() {
		return new db_dcl.Mensaje();
	}
	
	public static boolean save(db_dcl.Mensaje mensaje) throws PersistentException {
		try {
			db_dcl.MDS11920PFBlancoRoblesPersistentManager.instance().saveObject(mensaje);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(db_dcl.Mensaje mensaje) throws PersistentException {
		try {
			db_dcl.MDS11920PFBlancoRoblesPersistentManager.instance().deleteObject(mensaje);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(db_dcl.Mensaje mensaje)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(db_dcl.Mensaje mensaje, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (mensaje.getUsuarios() != null) {
				mensaje.getUsuarios().pro_mensajes.remove(mensaje);
			}
	...
	public static boolean refresh(db_dcl.Mensaje mensaje) throws PersistentException {
		try {
			db_dcl.MDS11920PFBlancoRoblesPersistentManager.instance().getSession().refresh(mensaje);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(db_dcl.Mensaje mensaje) throws PersistentException {
		try {
			db_dcl.MDS11920PFBlancoRoblesPersistentManager.instance().getSession().evict(mensaje);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();

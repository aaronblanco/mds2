...
public class NotificacionDAO {
	...
	public static Notificacion loadNotificacionByORMID(PersistentSession session, int idNotificacion) throws PersistentException {
		try {
			return (Notificacion) session.load(db_dcl.Notificacion.class, new Integer(idNotificacion));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Notificacion getNotificacionByORMID(PersistentSession session, int idNotificacion) throws PersistentException {
		try {
			return (Notificacion) session.get(db_dcl.Notificacion.class, new Integer(idNotificacion));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Notificacion loadNotificacionByORMID(PersistentSession session, int idNotificacion, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Notificacion) session.load(db_dcl.Notificacion.class, new Integer(idNotificacion), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Notificacion getNotificacionByORMID(PersistentSession session, int idNotificacion, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Notificacion) session.get(db_dcl.Notificacion.class, new Integer(idNotificacion), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Notificacion createNotificacion() {
		return new db_dcl.Notificacion();
	}
	
	public static boolean save(db_dcl.Notificacion notificacion) throws PersistentException {
		try {
			db_dcl.MDS11920PFBlancoRoblesPersistentManager.instance().saveObject(notificacion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(db_dcl.Notificacion notificacion) throws PersistentException {
		try {
			db_dcl.MDS11920PFBlancoRoblesPersistentManager.instance().deleteObject(notificacion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(db_dcl.Notificacion notificacion)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(db_dcl.Notificacion notificacion, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (notificacion.getUsuarios() != null) {
				notificacion.getUsuarios().notificaciones.remove(notificacion);
			}
	...
	public static boolean refresh(db_dcl.Notificacion notificacion) throws PersistentException {
		try {
			db_dcl.MDS11920PFBlancoRoblesPersistentManager.instance().getSession().refresh(notificacion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(db_dcl.Notificacion notificacion) throws PersistentException {
		try {
			db_dcl.MDS11920PFBlancoRoblesPersistentManager.instance().getSession().evict(notificacion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();

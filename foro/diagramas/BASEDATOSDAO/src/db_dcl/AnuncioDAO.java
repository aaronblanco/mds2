...
public class AnuncioDAO {
	...
	public static Anuncio loadAnuncioByORMID(PersistentSession session, int idAnuncio) throws PersistentException {
		try {
			return (Anuncio) session.load(db_dcl.Anuncio.class, new Integer(idAnuncio));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Anuncio getAnuncioByORMID(PersistentSession session, int idAnuncio) throws PersistentException {
		try {
			return (Anuncio) session.get(db_dcl.Anuncio.class, new Integer(idAnuncio));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Anuncio loadAnuncioByORMID(PersistentSession session, int idAnuncio, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Anuncio) session.load(db_dcl.Anuncio.class, new Integer(idAnuncio), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Anuncio getAnuncioByORMID(PersistentSession session, int idAnuncio, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Anuncio) session.get(db_dcl.Anuncio.class, new Integer(idAnuncio), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Anuncio createAnuncio() {
		return new db_dcl.Anuncio();
	}
	
	public static boolean save(db_dcl.Anuncio anuncio) throws PersistentException {
		try {
			db_dcl.MDS11920PFBlancoRoblesPersistentManager.instance().saveObject(anuncio);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(db_dcl.Anuncio anuncio) throws PersistentException {
		try {
			db_dcl.MDS11920PFBlancoRoblesPersistentManager.instance().deleteObject(anuncio);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(db_dcl.Anuncio anuncio) throws PersistentException {
		try {
			db_dcl.MDS11920PFBlancoRoblesPersistentManager.instance().getSession().refresh(anuncio);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(db_dcl.Anuncio anuncio) throws PersistentException {
		try {
			db_dcl.MDS11920PFBlancoRoblesPersistentManager.instance().getSession().evict(anuncio);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();

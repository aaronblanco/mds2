...
public class TemaDAO {
	...
	public static Tema loadTemaByORMID(PersistentSession session, int idTema) throws PersistentException {
		try {
			return (Tema) session.load(db_dcl.Tema.class, new Integer(idTema));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Tema getTemaByORMID(PersistentSession session, int idTema) throws PersistentException {
		try {
			return (Tema) session.get(db_dcl.Tema.class, new Integer(idTema));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Tema loadTemaByORMID(PersistentSession session, int idTema, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Tema) session.load(db_dcl.Tema.class, new Integer(idTema), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Tema getTemaByORMID(PersistentSession session, int idTema, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Tema) session.get(db_dcl.Tema.class, new Integer(idTema), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Tema createTema() {
		return new db_dcl.Tema();
	}
	
	public static boolean save(db_dcl.Tema tema) throws PersistentException {
		try {
			db_dcl.MDS11920PFBlancoRoblesPersistentManager.instance().saveObject(tema);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(db_dcl.Tema tema) throws PersistentException {
		try {
			db_dcl.MDS11920PFBlancoRoblesPersistentManager.instance().deleteObject(tema);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(db_dcl.Tema tema)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(db_dcl.Tema tema, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (tema.getUsuarios() != null) {
				tema.getUsuarios().pro_temas.remove(tema);
			}
	...
	public static boolean refresh(db_dcl.Tema tema) throws PersistentException {
		try {
			db_dcl.MDS11920PFBlancoRoblesPersistentManager.instance().getSession().refresh(tema);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(db_dcl.Tema tema) throws PersistentException {
		try {
			db_dcl.MDS11920PFBlancoRoblesPersistentManager.instance().getSession().evict(tema);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();

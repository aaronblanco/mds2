...
public class TicketDAO {
	...
	public static Ticket loadTicketByORMID(PersistentSession session, int idTicket) throws PersistentException {
		try {
			return (Ticket) session.load(com.mds2.foro.Ticket.class, new Integer(idTicket));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Ticket getTicketByORMID(PersistentSession session, int idTicket) throws PersistentException {
		try {
			return (Ticket) session.get(com.mds2.foro.Ticket.class, new Integer(idTicket));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Ticket loadTicketByORMID(PersistentSession session, int idTicket, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Ticket) session.load(com.mds2.foro.Ticket.class, new Integer(idTicket), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Ticket getTicketByORMID(PersistentSession session, int idTicket, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Ticket) session.get(com.mds2.foro.Ticket.class, new Integer(idTicket), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryTicket(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From com.mds2.foro.Ticket as Ticket");
		if (condition != null)
	...
	public static Ticket createTicket() {
		return new com.mds2.foro.Ticket();
	}
	
	public static boolean save(com.mds2.foro.Ticket ticket) throws PersistentException {
		try {
			MDS11920PFBlancoRoblesPersistentManager.instance().saveObject(ticket);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(com.mds2.foro.Ticket ticket) throws PersistentException {
		try {
			MDS11920PFBlancoRoblesPersistentManager.instance().deleteObject(ticket);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(com.mds2.foro.Ticket ticket)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(com.mds2.foro.Ticket ticket, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (ticket.getUsuarios() != null) {
				ticket.getUsuarios().pro_tickets.remove(ticket);
			}
	...
	public static boolean refresh(com.mds2.foro.Ticket ticket) throws PersistentException {
		try {
			MDS11920PFBlancoRoblesPersistentManager.instance().getSession().refresh(ticket);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(com.mds2.foro.Ticket ticket) throws PersistentException {
		try {
			MDS11920PFBlancoRoblesPersistentManager.instance().getSession().evict(ticket);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();

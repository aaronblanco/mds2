...
public class Notificacion implements Serializable {
	...
	private void this_setOwner(Object owner, int key) {
		if (key == ORMConstants.KEY_NOTIFICACION_USUARIOS) {
	...
	@Id	
	@GeneratedValue(generator="COM_MDS2_FORO_NOTIFICACION_IDNOTIFICACION_GENERATOR")	
	@org.hibernate.annotations.GenericGenerator(name="COM_MDS2_FORO_NOTIFICACION_IDNOTIFICACION_GENERATOR", strategy="native")	

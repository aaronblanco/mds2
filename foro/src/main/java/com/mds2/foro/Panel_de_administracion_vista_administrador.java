...
public class Panel_de_administracion_vista_administrador extends PanelAdministracionGenerico {
	...
	public Panel_de_administracion_vista_administrador() throws PersistentException {
		super();

...
public class MensajeBD implements Serializable {
	...
	private java.util.Set this_getSet (int key) {
		if (key == com.mds2.foro.ORMConstants.KEY_MENSAJE_CONTIENE_IMAGENES) {
	...
	private void this_setOwner(Object owner, int key) {
		if (key == com.mds2.foro.ORMConstants.KEY_MENSAJE_USUARIOS) {
			this.usuarios = (com.mds2.foro.UsuariosBD) owner;
		}
		
		else if (key == com.mds2.foro.ORMConstants.KEY_MENSAJE_CONTIENE_VIDEOS) {
	...
	@Transient	
	public final com.mds2.foro.imagenesSetCollection contiene_imagenes = new com.mds2.foro.imagenesSetCollection(this, _ormAdapter, com.mds2.foro.ORMConstants.KEY_MENSAJE_CONTIENE_IMAGENES, com.mds2.foro.ORMConstants.KEY_MUL_ONE_TO_MANY);

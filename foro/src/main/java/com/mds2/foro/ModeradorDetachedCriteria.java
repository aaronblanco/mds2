...
public class ModeradorDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public ModeradorDetachedCriteria() {
		super(com.mds2.foro.ModeradorBD.class, com.mds2.foro.ModeradorCriteria.class);
	...
	public ModeradorDetachedCriteria(DetachedCriteria aDetachedCriteria) {
		super(aDetachedCriteria, com.mds2.foro.ModeradorCriteria.class);
		idUsuario = new IntegerExpression("idUsuario", this.getDetachedCriteria());
		email = new StringExpression("email", this.getDetachedCriteria());
		descripcion = new StringExpression("descripcion", this.getDetachedCriteria());
		nombreUsuario = new StringExpression("nombreUsuario", this.getDetachedCriteria());
	...
	public ModeradorBD uniqueModerador(PersistentSession session) {
		return (ModeradorBD) super.createExecutableCriteria(session).uniqueResult();
	}
	
	public ModeradorBD[] listModerador(PersistentSession session) {

...
public class AdministradorCriteria extends AbstractORMCriteria {
	...
	public AdministradorCriteria(PersistentSession session) {
		this(session.createCriteria(AdministradorBD.class));
	}
	...
	public AdministradorBD uniqueAdministrador() {
		return (AdministradorBD) super.uniqueResult();
	}
	
	public AdministradorBD[] listAdministrador() {
